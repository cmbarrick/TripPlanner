...
DECLARE
    ...
    missing_fks int;
BEGIN
    RAISE NOTICE 'Phase 0 Postgres smoke test starting...';
    RAISE NOTICE 'Validating schema + constraints (pgAdmin-compatible script).';
...
DO $$ BEGIN
    RAISE NOTICE 'Phase 0 Postgres smoke test passed.';
END $$;
